...
contract KeyedPlonkVerifier is PlonkVerifier {
    ...
    function get_verification_key() internal pure returns(VerificationKey memory vk) {
        ...
        vk.selector_commitments[0] = PairingsBn254.new_g1(
        	uint256(7238514640747599171138845437293318831682608180041252318731807978573276812873),
        	uint256(8380493305738121202512318725365223931881415499129935316968050122461503286044)
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
			uint256(12897746913047327198619723371380526130480757424032204419317740971156927864956),
			uint256(19678336388398240527354947885958931028971303304211380453338526597930421972331)
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
			uint256(19015916387666161541526705572693176199275239270031622946129106505683738520204),
			uint256(12298061263309683658759707778940660701069454825090953913793381084712078758602)
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
			uint256(19015916387666161541526705572693176199275239270031622946129106505683738520204),
			uint256(9590181608529591563486697966316614387626856332206869748895656809933147449981)
        );
        ...
        vk.permutation_commitments[0] = PairingsBn254.new_g1(
        	uint256(13023879669918709848608628750789985652706877571174126691178809959813870689588),
			uint256(20863619186204026477587946502731896067977935136913644028064775236668931503199)
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
			uint256(20132398568842805846316448119091103608224803007323277048865691951819785607756),
			uint256(3114312294727237859927176601235942317903613413689766541655913094752173299587)
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
			uint256(17512686914969331000953949382033374991719055695780216999016134824475601973102),
			uint256(7983212213249491866133059516239751669480573525769696774861915432476862860652)
        );
        ...
        vk.g2_x = PairingsBn254.new_g2(
			[uint256(9617287746484448236243316687002191389776751292780605049561046497832350154152),
			uint256(15774713514346592357822375826581680100444811915777004185954256430905692183132)],
			[uint256(11980152824128373209004739501436799061267006667101105171364208958895882485483),
			uint256(20730163111339975770936109062725491316357973132199957488011532907139815633699)]
        );
    }
